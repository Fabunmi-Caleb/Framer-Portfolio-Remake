function Navbar() {
  return (
    <nav className="flex border-b-[1px] shadow-sm p-4 justify-between items-center w-full fixed bg-[rgb(252,252,253)]">
      <p className="font-semibold text-base cursor-pointer text-secondary">
        LucaDCZ
        <span className="leading-0 text-primary text-3xl leading-[0px]">
          .
        </span>
      </p>
